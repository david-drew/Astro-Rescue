...
@export var lander_path: NodePath = NodePath("Lander")
@export var buggy_path: NodePath = NodePath("Buggy")
@export var eva_path: NodePath = NodePath("EVA")
...
func _ready() -> void:
	...
	# Start in HQ unless something else sets mode immediately.
...
func _on_set_vehicle_mode(vehicle:String):
	var new_mode:String = 